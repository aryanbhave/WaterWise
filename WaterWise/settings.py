"""
Django settings for WaterWise project.
...
SECRET_KEY = 'django-insecure-u%k!$-g2hv45695u$-7^nyrpx_@z=$qr_lmv&cwc%g_mbt_#la'
...
WSGI_APPLICATION = 'WaterWise.wsgi.application'
...
LOGIN_REDIRECT_URL = 'logger-home'
LOGIN_URL = 'login'
